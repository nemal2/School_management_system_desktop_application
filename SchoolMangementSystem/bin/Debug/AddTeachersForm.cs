...
namespace SchoolMangementSystem
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\SQL_Server_Management\SQL_Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\schools.mdf;Integrated Security=True;Connect Timeout=30");
                    ...
                    try
                    {
                        ...
                        using(SqlCommand checkTID = new SqlCommand(checkTeacherID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"E:\4_semester\Past_Projects\Desktop_POS\pos3\School-Management-System-using-CSharp-main\SchoolMangementSystem\SchoolMangementSystem\Teacher_Directory\", teacher_id.Text.Trim() + ".jpg");
		...
		private void teacher_image_Click(object sender, EventArgs e)
		{
