                    ...
                    try
                    {
                        ...
                        using (SqlCommand checkSID = new SqlCommand(checkStudentID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"E:\4_semester\Past_Projects\Desktop_POS\pos3\School-Management-System-using-CSharp-main\SchoolMangementSystem\SchoolMangementSystem\Student_Directory\", student_id.Text.Trim() + ".jpg");
